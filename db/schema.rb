...
ActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "agenda", :force => true do |t|
  ...
  add_index "developer", ["id_address"], :name => "fk_developer_address"
  add_index "developer", ["id_user"], :name => "fk_developer_users1"

  create_table "developer_formats", :id => false, :force => true do |t|
    t.integer "id",           :null => false
    t.integer "id_developer", :null => false
    t.integer "id_format",    :null => false
  end

  add_index "developer_formats", ["id_developer"], :name => "fk_developer_formats_developer1"
  add_index "developer_formats", ["id_format"], :name => "fk_developer_formats_formats1"
